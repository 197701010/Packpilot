...
export default function FinalPageClient() {
  ...
  // AANPASSING HIER: De knop stuurt nu door naar de resultatenpagina
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-5xl mx-auto py-12 px-4">
        {/* De rest van de JSX blijft precies hetzelfde... */}
              ...
              {variationsData.map(variation => (
                <div key={variation.id} className="flex items-center gap-4">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" checked={!!selectedVariations[variation.id]} onChange={() => handleVariationToggle(variation.id)} className="sr-only peer" />
