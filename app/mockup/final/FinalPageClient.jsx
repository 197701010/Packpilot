...
// Data voor de creative variations
...
export default function FinalPageClient() {
  ...
  // State voor de keuzes op deze pagina
  const [numImages, setNumImages] = useState(9);
  const [selectedVariations, setSelectedVariations] = useState({});
  const totalCredits = 10;

  // State voor alle ontvangen data van vorige pagina's
  ...
  // Bereken de gebruikte credits
  const usedCredits = useMemo(() => {
    let credits = numImages; // 1 credit per image
